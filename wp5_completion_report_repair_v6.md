# WP5 completion report (repair_v6)
...
[provenance/wp5_repair_v6_gate.json](provenance/wp5_repair_v6_gate.json).
...
|---|---:|---:|---:|---:|:--:|
| CygOB2-A | 0.4417 | 0.872 | 1.41 | 3.997 | yes |
| CygOB2-B | 0.2239 | 0.111 | 2.43 | 4.066 | yes |
| CygOB2-C | 0.3923 | 0.957 | 1.57 | 2.516 | yes |
...
**All G3 sub-criteria met.**

Branch grid: **40/54** subgroup-branch fits pass,
under the retention policy in `CUTS_AND_THRESHOLDS.md` §13.
Association mass 29122
[28042,
30226] M☉, within a factor two of the
16,500 M☉ literature scale: True.

## Downstream authorization

`downstream_wp6_authorized = true`.
...
PYTHONPATH=scripts python3 scripts/wp5_report.py --wp5-version repair_v6
PYTHONPATH=scripts python3 scripts/wp5_repair_v4_finalize.py --wp5-version repair_v6
```
