...
| WP6 | Census closure + runaways | **RUN, GATE MET, ONE DIAGNOSTIC OPEN.** The census very nearly closes at Salpeter: observed massive stars exceed prediction by **11%** (α=2.3, grid median) and the closing slope is **α ≈ 2.23** [2.03–2.31], with **17/18** cells inside the carried grid. Two defects were found and fixed after the first run: **issue #17** (the forward integral truncated at the 8 M☉ threshold the response smears across) absorbed ~3/4 of the excess, and **issue #16** (absolute instead of peculiar proper motions) invalidated the traceback. Runaways now **119 raw → 54.9** corrected; living ledger **380.6** above 8 M☉. External gate **PASSED** — BD+43 3654 recovered at p = 1.000, 38.8 km/s, 1.36 Myr against a literature ~40 km/s and 1.6 Myr. Withdrawn and not to be quoted: 45% excess, grid median 1.444, closing α 2.070, 260/109 runaways, 471.9 ledger. Open: **issue #15**, the multiplicity diagnostic | see [wp6_closure.md](wp6_closure.md) |
...
1. **The one open WP6 item: the literature runaway cross-match.** The plan's
   ...
   result with no per-star confirmation.
...
6. **Discharge the remaining WP3 adoption obligations** from
   ...
   discharged.
7. **Carried methodological finding for the systematics section.** At
...
| [Härer+2025](cross_checks/harer_2025_supernova_rate.md) / Wright+2015 | association mass | **1.74 × 10⁴ M☉** | 1.65 × 10⁴ M☉ | **agree, 5%** |
