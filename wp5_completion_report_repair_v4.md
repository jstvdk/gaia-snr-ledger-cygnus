# WP5 completion report (repair_v4)
...
[provenance/wp5_repair_v4_gate.json](provenance/wp5_repair_v4_gate.json).
...
|---|---:|---:|---:|---:|:--:|
| CygOB2-A | 0.3803 | 0.872 | 1.45 | 3.981 | yes |
| CygOB2-B | 0.0229 | 0.111 | 2.51 | 3.395 | yes |
| CygOB2-C | 0.4920 | 0.872 | 1.52 | 2.512 | yes |
...
Branch grid: **29/54** subgroup-branch fits pass,
under the retention policy in `CUTS_AND_THRESHOLDS.md` §13.
Association mass 30155
[28987,
31312] M☉, within a factor two of the
...
PYTHONPATH=scripts python3 scripts/wp5_report.py --wp5-version repair_v4
PYTHONPATH=scripts python3 scripts/wp5_repair_v4_finalize.py --wp5-version repair_v4
```
